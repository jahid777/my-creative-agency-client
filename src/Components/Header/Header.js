        ...
        <main className="main-header-container">
            ...
            <div className="row container">
                <div className="col-md-6 col-sm-12">
                    ...
                    <button className="main-button" style={{justifyContent:'center',marginLeft:'134px'}}>Hire Us</button>
                </div>

                <div className="col-md-6 col-sm-12">
                    <img style={{height:'400px',marginLeft:'10px',marginTop:'20px'}} src={img} alt=""/>
                </div>
